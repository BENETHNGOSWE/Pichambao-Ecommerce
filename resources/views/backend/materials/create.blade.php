                        ...
                        <div class="col-lg-8">
                            <div class="task-modal-left">
                                ...
                                <div class="input-style-1">
                                    ...
                                    <input type="text" class="form-control" id="material_quatity" name="material_quatity" required>
                                </div>

                                <div class="input-style-1">
                                    <label for="material_price">Material Price</label>
                                    <input type="text" class="form-control" id="material_price" name="material_price" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="task-modal-left">
                                ...
                                <div class="select-style-1">
                                    ...
                                    <div class="select-position">
                                        <select class="form-control" id="material_size" name="material_size" required>
                                ...
                                <div class="input-style-1">
                                    ...
                                    <input type="date" class="form-control" id="material_buyingdate" name="material_buyingdate" required>
                                </div>
