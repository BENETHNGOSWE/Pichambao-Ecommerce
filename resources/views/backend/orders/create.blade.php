                        ...
                        <div class="col-lg-8">
                            <div class="task-modal-left">
                                ...
                                <div class="input-style-1">
                                    ...
                                    <input type="text" class="form-control" id="order_paidedamount" name="order_paidedamount" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="task-modal-left">
                                ...
                                <div class="input-style-1">
                                    ...
                                    <input type="date" class="form-control" id="order_enddate" name="order_enddate" required>
                                </div>
