...
<main class="main-wrapper">
    <section class="section">
        <div class="container-fluid">
            ...
            <div>
                <form method="POST" action="{{ route('debtors.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="task-modal-left">
                                ...
                                <div class="input-style-1">
                                    ...
                                    <input type="text" class="form-control" id="debtor_phonenumber" name="debtor_phonenumber" required>
                                </div>

                                <div class="input-style-1">
                                    <label for="material_taken">Material Taken</label>
                                    <input type="text" class="form-control" id="material_taken" name="material_taken" required>
                                </div>
                        ...
                        <div class="col-lg-4">
                            <div class="task-modal-left">
                                ...
                                <div class="input-style-1">
                                    ...
                                    <input type="text" class="form-control" id="debtor_address" name="debtor_address" required>
                                </div>
